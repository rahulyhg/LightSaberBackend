    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/createpredictionsubmit");?>' enctype='multipart/form-data'>
                    <div class="panel-body">
                        <div class=" form-group">
                            <label class="col-sm-2 control-label" for="normal-field">Prediction Group</label>
                            <div class="col-sm-4">
                                <?php echo form_dropdown( "predictiongroup",$predictiongroup,set_value( 'predictiongroup'), "class='chzn-select form-control'");?>
                            </div>
                        </div>
                        <div class="form-group">
