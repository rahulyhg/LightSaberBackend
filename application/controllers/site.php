...
class Site extends CI_Controller {
    ...
    function createusersubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->user_model->create($name, $email, $password, $accesslevel, $status, $socialid, $logintype, $image, $json, $points) == 0) $data['alerterror'] = "New user could not be created.";
            else $data['alertsuccess'] = "User created Successfully.";
    ...
    function editusersubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->user_model->edit($id, $name, $email, $password, $accesslevel, $status, $socialid, $logintype, $image, $json, $points) == 0) $data['alerterror'] = "User Editing was unsuccesful";
            else $data['alertsuccess'] = "User edited Successfully.";
            $data['redirect'] = "site/viewusers";
    ...
    public function createsocialloginsubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $name = $this->input->get_post("name");
            if ($this->sociallogin_model->create($name) == 0) $data["alerterror"] = "New sociallogin could not be created.";
            else $data["alertsuccess"] = "sociallogin created Successfully.";
    ...
    public function editsocialloginsubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $id = $this->input->get_post("id");
            $name = $this->input->get_post("name");
            if ($this->sociallogin_model->edit($id, $name) == 0) $data["alerterror"] = "New sociallogin could not be Updated.";
            else $data["alertsuccess"] = "sociallogin Updated Successfully.";
            $data["redirect"] = "site/viewsociallogin";
            $this->load->view("redirect", $data);
        }
    }
    ...
    public function createpredictiongroupsubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->predictiongroup_model->create($name, $order, $status, $endtime) == 0) $data["alerterror"] = "New predictiongroup could not be created.";
            else $data["alertsuccess"] = "predictiongroup created Successfully.";
    ...
    public function editpredictiongroupsubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $status = $this->input->get_post("status");
            $endtime = $this->input->get_post("endtime");
            if ($this->predictiongroup_model->edit($id, $name, $order, $status, $endtime) == 0) $data["alerterror"] = "New predictiongroup could not be Updated.";
            else $data["alertsuccess"] = "predictiongroup Updated Successfully.";
            $data["redirect"] = "site/viewpredictiongroup";
            $this->load->view("redirect", $data);
        }
    }
    ...
    public function createteamgroupsubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $order = $this->input->get_post("order");
            if ($this->teamgroup_model->create($name, $predictiongroup, $order) == 0) $data["alerterror"] = "New teamgroup could not be created.";
            else $data["alertsuccess"] = "teamgroup created Successfully.";
    ...
    public function editteamgroupsubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $predictiongroup = $this->input->get_post("predictiongroup");
            $order = $this->input->get_post("order");
            if ($this->teamgroup_model->edit($id, $name, $predictiongroup, $order) == 0) $data["alerterror"] = "New teamgroup could not be Updated.";
            else $data["alertsuccess"] = "teamgroup Updated Successfully.";
            $data["redirect"] = "site/viewteamgroup";
            $this->load->view("redirect", $data);
        }
    }
    ...
    function viewpredictionjson() {
        ...
        $elements[11]->field="count(`predicto_prediction`.`id`)";
        $elements[11]->sort="1";
        $elements[11]->header="Total Predictions";
        $elements[11]->alias="total";
        $search = $this->input->get_post("search");
        $pageno = $this->input->get_post("pageno");
        $orderby = $this->input->get_post("orderby");
        $orderorder = $this->input->get_post("orderorder");
...
","","GROUP BY  `predicto_prediction`.`id`");
    ...
    public function createpredictionteamsubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $order = $this->input->get_post("order");
            if ($this->predictionteam_model->create($prediction, $teamgroup, $order) == 0) $data["alerterror"] = "New predictionteam could not be created.";
            else $data["alertsuccess"] = "predictionteam created Successfully.";
    ...
    public function editpredictionteamsubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $teamgroup = $this->input->get_post("teamgroup");
            $order = $this->input->get_post("order");
            if ($this->predictionteam_model->edit($id, $prediction, $teamgroup, $order) == 0) $data["alerterror"] = "New predictionteam could not be Updated.";
            else $data["alertsuccess"] = "predictionteam Updated Successfully.";
            $data["redirect"] = "site/viewpredictionteam";
            $this->load->view("redirect", $data);
        }
    }
    ...
    public function createuserpredictionsubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $teamgroup = $this->input->get_post("teamgroup");
            $prediction = $this->input->get_post("prediction");
            if ($this->userprediction_model->create($user, $teamgroup, $prediction) == 0) $data["alerterror"] = "New userprediction could not be created.";
            else $data["alertsuccess"] = "userprediction created Successfully.";
    ...
    public function edituserpredictionsubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $teamgroup = $this->input->get_post("teamgroup");
            $prediction = $this->input->get_post("prediction");
            if ($this->userprediction_model->edit($id, $user, $teamgroup, $prediction) == 0) $data["alerterror"] = "New userprediction could not be Updated.";
            else $data["alertsuccess"] = "userprediction Updated Successfully.";
            $data["redirect"] = "site/viewuserprediction";
            $this->load->view("redirect", $data);
        }
    }
    ...
    public function createpredictionhashsubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->predictionhash_model->create($prediction, $hashtag) == 0) $data["alerterror"] = "New predictionhash could not be created.";
            else $data["alertsuccess"] = "predictionhash created Successfully.";
    ...
    public function editpredictionhashsubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $prediction = $this->input->get_post("prediction");
            $hashtag = $this->input->get_post("hashtag");
            if ($this->predictionhash_model->edit($id, $prediction, $hashtag) == 0) $data["alerterror"] = "New predictionhash could not be Updated.";
            else $data["alertsuccess"] = "predictionhash Updated Successfully.";
            $data["redirect"] = "site/viewpredictionhash";
            $this->load->view("redirect", $data);
        }
    }
    ...
    public function createusersharesubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->usershare_model->create($user, $sharecontent, $total, $prediction, $predictionhash) == 0) $data["alerterror"] = "New usershare could not be created.";
            else $data["alertsuccess"] = "usershare created Successfully.";
    ...
    public function editusersharesubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $prediction = $this->input->get_post("prediction");
            $predictionhash = $this->input->get_post("predictionhash");
            if ($this->usershare_model->edit($id, $user, $sharecontent, $total, $prediction, $predictionhash) == 0) $data["alerterror"] = "New usershare could not be Updated.";
            else $data["alertsuccess"] = "usershare Updated Successfully.";
            $data["redirect"] = "site/viewusershare";
            $this->load->view("redirect", $data);
        }
    }
    ...
    public function createusersharehashsubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $predictionhash = $this->input->get_post("predictionhash");
            if ($this->usersharehash_model->create($usershare, $predictionhash) == 0) $data["alerterror"] = "New usersharehash could not be created.";
            else $data["alertsuccess"] = "usersharehash created Successfully.";
    ...
    public function editusersharehashsubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $usershare = $this->input->get_post("usershare");
            $predictionhash = $this->input->get_post("predictionhash");
            if ($this->usersharehash_model->edit($id, $usershare, $predictionhash) == 0) $data["alerterror"] = "New usersharehash could not be Updated.";
            else $data["alertsuccess"] = "usersharehash Updated Successfully.";
            $data["redirect"] = "site/viewusersharehash";
            $this->load->view("redirect", $data);
        }
    }
    ...
    public function createuserpointlogsubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->userpointlog_model->create($point, $for, $prediction, $shareid) == 0) $data["alerterror"] = "New userpointlog could not be created.";
            else $data["alertsuccess"] = "userpointlog created Successfully.";
    ...
    public function edituserpointlogsubmit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $prediction = $this->input->get_post("prediction");
            $shareid = $this->input->get_post("shareid");
            if ($this->userpointlog_model->edit($id, $point, $for, $prediction, $shareid) == 0) $data["alerterror"] = "New userpointlog could not be Updated.";
            else $data["alertsuccess"] = "userpointlog Updated Successfully.";
            $data["redirect"] = "site/viewuserpointlog";
            $this->load->view("redirect", $data);
        }
    }
